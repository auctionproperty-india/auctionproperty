...
// ---- Base query for available auction properties ----
$base_sql = "SELECT * FROM properties WHERE status = 'available'";
if(!empty($where_clause)) {
    $base_sql .= " AND " . $where_clause;
}

// ---- Today's Auctions (using auction_date = CURRENT_DATE) ----
...
<head>
    ...
    <title>Prime Property – Auction</title>
