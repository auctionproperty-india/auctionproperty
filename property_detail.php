                ...
                <div class="card-body p-0">
                    <div class="row g-0">
                        ...
                        <div class="col-lg-8 p-4">
                            <!-- ✅ Auction Date (Now visible here) -->
                            <div class="alert alert-info mb-4">
                                <i class="fas fa-calendar-alt me-2"></i>
                                <strong>Auction Date:</strong> 
                                <?= !empty($prop['auction_date']) ? date('d M Y', strtotime($prop['auction_date'])) : 'Not Set' ?>
                            </div>
                            ...
                            <div class="card border-0 shadow-sm mb-4 rounded-4 overflow-hidden">
                                <div class="card-header bg-dark text-white"><i class="fas fa-clock me-2"></i> Auction Schedule & Price</div>
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-md-6">
