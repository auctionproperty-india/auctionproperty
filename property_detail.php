...
// ---- IF NOT SUBSCRIBED: Minimal but Beautiful Layout ----
if(!$has_subscription) {
    include 'header.php'; 
    ?>
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-lg" style="border-radius: 30px; overflow: hidden;">
                    ...
                    <div class="card-body p-4" style="background: #f8fafc;">
                        ...
                        <!-- ✅ 3 Key Details in Compact Boxes -->
                        <div class="row g-3">
                            <div class="col-md-4">
...
// ----- SUBSCRIBED USER: Modern, Compact, Beautiful Full Detail -----
include 'header.php'; 
?>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="card border-0 shadow-xxl" style="border-radius: 28px; overflow: hidden; background: #ffffff;">
                ...
                <div class="card-header p-4" style="background: linear-gradient(135deg, #1e293b 0%, #334155 100%); border: none;">
