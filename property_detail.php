...
<div class="container-fluid px-4 mt-4">
    <div class="row">
        <div class="col-12">
            ...
            <!-- ✅ MAIN DETAIL CARD - LARAVEL SHINING STYLE -->
            <div class="card border-0 shadow-xxl" style="border-radius: 28px; overflow: hidden; background: #ffffff; backdrop-filter: blur(10px);">
                ...
                <div class="card-body p-0">
                    <div class="row g-0">
                        ...
                        <div class="col-lg-8 p-4">
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-6">
                                    <div class="bg-light p-3 rounded-4 h-100">
                                        <small class="text-muted text-uppercase fw-bold">Borrower</small>
                                        <h5 class="fw-bold"><?= htmlspecialchars($prop['borrower_name'] ?? 'N/A') ?></h5>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="bg-light p-3 rounded-4 h-100">
                                        <small class="text-muted text-uppercase fw-bold">Property Type</small>
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-4">
                                    <div class="bg-gradient-to-br p-3 rounded-4" style="background: #f8fafc;">
                                        <small class="text-muted"><i class="fas fa-map-pin me-1"></i> City</small>
                                        <h6 class="fw-bold"><?= htmlspecialchars($prop['city']) ?></h6>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="bg-gradient-to-br p-3 rounded-4" style="background: #f8fafc;">
                                        <small class="text-muted"><i class="fas fa-location-dot me-1"></i> Locality</small>
                                        <h6 class="fw-bold"><?= htmlspecialchars($prop['locality'] ?? 'N/A') ?></h6>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="bg-gradient-to-br p-3 rounded-4" style="background: #f8fafc;">
                                        <small class="text-muted"><i class="fas fa-vector-square me-1"></i> Area</small>
                            ...
                            <!-- ⏰ AUCTION TIMINGS & PRICE (महत्वपूर्ण) -->
                            <div class="card border-0 shadow-sm mb-4 rounded-4 overflow-hidden">
                                <div class="card-header bg-dark text-white">
                                    <i class="fas fa-clock me-2"></i> Auction Schedule & Price
                                </div>
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <div class="border-bottom pb-2"><strong>Start:</strong> <?= htmlspecialchars($prop['auction_start_time'] ?? 'Not Set') ?></div>
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-md-4">
                                    <div class="p-3 rounded-4 text-center" style="background: linear-gradient(145deg, #e0e7ff, #c7d2fe);">
                                        ...
                                        <h4 class="fw-bold">₹ <?= indianCurrencyFormat($prop['emd_amount'] ?? 0) ?></h4>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="p-3 rounded-4 text-center" style="background: linear-gradient(145deg, #d1fae5, #a7f3d0);">
                                        ...
                                        <h4 class="fw-bold">₹ <?= indianCurrencyFormat($prop['bid_increment'] ?? 0) ?></h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="p-3 rounded-4" style="background: #f0fdf4; border: 1px solid #bbf7d0;">
                                        <i class="fas fa-phone text-success me-2"></i> <strong>Contact:</strong> <?= htmlspecialchars($prop['contact_number'] ?? 'N/A') ?>
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="col-lg-4 p-4" style="background: #f8fafc;">
                            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                                <img src="<?= htmlspecialchars($prop['image_url'] ?: 'https://via.placeholder.com/600x400?text=Property') ?>" class="img-fluid" style="height: 280px; width: 100%; object-fit: cover;">
                            </div>
