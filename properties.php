...
// ---- 🚀 सबसे पहले All POST/GET Logic (Header से पहले) ----
if(!isset($_SESSION['user_id']) || $_SESSION['role'] != 'admin') { 
    header("Location: dashboard.php"); 
    exit; 
}

// Default Contact Number फेच करें (Settings से)
...
// ---- अब Header Include करें (जब कोई Redirect न बचा हो) ----
include 'header.php'; 
?>
...
<div class="card-premium" id="add-form" style="border-left: 4px solid #fbbf24;">
    ...
    <form method="POST" class="mt-3">
        <div class="row g-3">
            ...
            <div class="col-md-6"><label class="form-label fw-semibold">Address / Location</label><input type="text" name="location" class="form-control" required></div>
            ...
            <div class="col-md-4"><label class="form-label fw-semibold">Bank Name</label><input type="text" name="bank_name" class="form-control" placeholder="e.g. Union Bank of India"></div>
            ...
            <div class="col-md-3"><label class="form-label fw-semibold">Possession Type</label>
            ...
            <!-- Dates -->
            <div class="col-md-4"><label class="form-label fw-semibold">Auction Start Date & Time</label><input type="text" name="auction_start_time" class="form-control" placeholder="Wed, 24 Jun 2026 12:00 PM"></div>
            <div class="col-md-4"><label class="form-label fw-semibold">Auction End Date & Time</label><input type="text" name="auction_end_time" class="form-control" placeholder="Wed, 24 Jun 2026 05:00 PM"></div>
            <div class="col-md-4"><label class="form-label fw-semibold">EMD Submission Deadline</label><input type="text" name="emd_deadline" class="form-control" placeholder="Wed, 24 Jun 2026 05:00 PM"></div>
            ...
            <div class="col-md-6"><label class="form-label fw-semibold">Contact Number</label>
                ...
                <small class="text-muted">Default from Settings. Change per property if needed.</small>
            </div>
            <div class="col-md-6"><label class="form-label fw-semibold">Auction Date (for display)</label><input type="date" name="auction_date" class="form-control"></div>
            ...
            <div class="col-md-6"><label class="form-label fw-semibold">Google Map Link</label><input type="text" name="google_location" class="form-control" placeholder="https://maps.google.com/..."></div>
