<?php
// ============================================================
// 📥 Insert Users (ID > 87) - Remaining Users
// ============================================================
...
<html>
<head>
    <title>Insert Remaining Users</title>
    <style>
...
<body>
<div class='container'>
    <h1>📥 Insert Remaining Users (ID > 87)</h1>";
...
try {
    ...
    $pdo->exec($sql);
    echo "<div class='success'>✅ Remaining users (ID > 87) inserted successfully!</div>";

    // ---------- Verify ----------
    $stmt = $pdo->query("SELECT COUNT(*) FROM users");
    $count = $stmt->fetchColumn();
    echo "<div class='info'>📊 Total users now: $count</div>";

    // Show sample
    $stmt = $pdo->query("SELECT id, email, role FROM users ORDER BY id DESC LIMIT 10");
    echo "<h2>📋 Last 10 Users</h2>";
    ...
    echo "<hr>";
    echo "<div class='success'>🎉 All users imported!</div>";
