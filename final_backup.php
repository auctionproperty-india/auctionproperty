<?php
// ============================================================
// 📥 Final Backup – PostgreSQL → MySQL (No Errors, Clean)
// ============================================================

// Turn off all error output to avoid HTML in SQL file
error_reporting(0);
...
$sql = "-- ===================================================\n";
$sql .= "-- Final MySQL-Compatible Backup\n";
...
// Helper: map PostgreSQL data types to MySQL
...
// Helper: format default values for MySQL
function formatDefault($default, $data_type) {
    ...
    // Timestamp functions
    if (strpos($lower, 'current_timestamp') !== false || strpos($lower, 'now()') !== false) {
        return 'CURRENT_TIMESTAMP';
    }
    // Current_date is not supported in MySQL as default
...
foreach ($tables as $table) {
    // Get columns and their types, skip auto_increment id
    $cols = $pdo->query("
