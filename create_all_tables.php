...
echo "<h2>🔧 Creating all tables and columns...</h2>";
...
try {
    ...
    echo "✅ ticket_replies table created.<br>";

    echo "<hr><h3 style='color:green;'>✅ All tables and columns are ready!</h3>";
    echo "<p style='color:red; font-weight:bold;'>⚠️ Please delete this file (create_all_tables.php) immediately.</p>";

} catch (PDOException $e) {
    echo "<h3 style='color:red;'>❌ Error: " . $e->getMessage() . "</h3>";
    echo "<p>Check your database connection and that the 'users' table exists.</p>";
}
?>
