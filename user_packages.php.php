<?php
// ============================================================
// 📦 User Packages – Tricolor Bands + Ashok Chakra + Correct Price
// ============================================================
...
<style>
    ...
    .card-top .price-box .offer-price {
        font-size: 2.0rem;           /* थोड़ा बड़ा, पर regular से छोटा */
        font-weight: 700;
        color: #ffffff;
                        ...
                        <div class="card-top">
                            ...
                            <div class="price-box">
                                <?php if ($show_discount): ?>
                                    ...
                                    <!-- Discount Price – No Strike, with Right Arrow (→) -->
                                ...
                                <?php else: ?>
                                    <!-- अगर कोई discount नहीं, तो सिर्फ regular price बड़ा और बिना strike -->
                                    <span class="regular-price" style="text-decoration:none;">₹<?= number_format($regular_price, 0) ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
