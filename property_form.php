<div class="row g-3">
    ...
    <div class="col-md-4">
        ...
        <input type="text" name="emd_deadline" id="edit_emd_deadline" class="form-control">
    </div>
    <div class="col-md-4">
        <label class="form-label fw-semibold">Auction Start Date & Time</label>
        <input type="text" name="auction_start_time" id="edit_auction_start_time" class="form-control">
    </div>
    <div class="col-md-4">
        <label class="form-label fw-semibold">Auction End Date & Time</label>
        <input type="text" name="auction_end_time" id="edit_auction_end_time" class="form-control">
    </div>

    <!-- AUCTION DATE (DD/MM/YYYY) -->
    <div class="col-md-6">
        <label class="form-label fw-semibold">Auction Date (DD/MM/YYYY)</label>
        <input type="text" name="auction_date" id="edit_auction_date" class="form-control">
    </div>

    <!-- ===== CONTACT NUMBER HIDDEN (Not Editable) ===== -->
    <!-- ✅ Hidden Field – Admin को न दिखे और न बदल सके -->
