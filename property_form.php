<div class="row g-4">
    ...
    <div class="col-12">
        <div class="card bg-light p-3">
            <h5 class="fw-bold text-primary"><i class="fas fa-tag me-2"></i>Basic Details</h5>
    ...
    <div class="col-12">
        <div class="card bg-light p-3">
            <h5 class="fw-bold text-primary"><i class="fas fa-user me-2"></i>Borrower & Bank</h5>
            <div class="row g-3 mt-2">
                <div class="col-md-6">
    ...
    <div class="col-12">
        <div class="card bg-light p-3">
            <h5 class="fw-bold text-primary"><i class="fas fa-building me-2"></i>Property Details</h5>
            <div class="row g-3 mt-2">
                <div class="col-md-4">
    ...
    <div class="col-12">
        <div class="card bg-light p-3">
            <h5 class="fw-bold text-primary"><i class="fas fa-gavel me-2"></i>Auction Financials</h5>
            <div class="row g-3 mt-2">
                <div class="col-md-4">
    ...
    <div class="col-12">
        <div class="card bg-light p-3">
            <h5 class="fw-bold text-primary"><i class="fas fa-clock me-2"></i>Auction Schedule</h5>
            <div class="row g-3 mt-2">
                <div class="col-md-4">
    ...
    <div class="col-12">
        <div class="card bg-light p-3">
            <h5 class="fw-bold text-primary"><i class="fas fa-image me-2"></i>Media</h5>
            <div class="row g-3 mt-2">
                <div class="col-12">
