    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .sidebar {
            ...
            padding: 30px 15px; box-shadow: 4px 0 25px rgba(0,0,0,0.15);
            z-index: 1050; transition: transform 0.3s ease-in-out, background 0.3s;
            overflow-y: auto;
        }
        ...
        .sidebar a.active {
            background: #1e2a41; color: #ffffff; border-left-color: #fbbf24;
        }
        body.role-user .sidebar a.active {
            background: #10b981; color: #ffffff; border-left-color: #059669;
        }
        ...
        .main-content {
            margin-left: 280px; padding: 30px 35px; min-height: 100vh;
        ...
        .card-premium {
            border-radius: 20px; border: none; padding: 20px 24px; margin-bottom: 20px;
...
<div class="sidebar" id="mainSidebar">
    ...
    <?php if($role == 'admin'): ?>
        ...
        <?php endif; ?>
        <!-- ✅ Referral Payouts Link (Admin Sidebar) -->
        <?php if(hasPermission('referrals', $pdo)): ?>
    ...
    <?php else: ?>
        ...
        <!-- ✅ User Sidebar में Referrals Link (वैकल्पिक) -->
