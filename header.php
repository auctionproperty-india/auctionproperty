...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body.role-admin { background: #0f172a; } /* Admin की बैकग्राउंड डार्क */
        body.role-user { background: #f0f5fa; } /* User की बैकग्राउंड हल्की */
        ...
        body.role-user .sidebar .brand i { color: #10b981; } /* User का ग्रीन एक्सेंट */
        ...
        /* --- MAIN CONTENT (Role Based Card Backgrounds) --- */
        .main-content {
            margin-left: 280px;
            padding: 30px 35px;
            min-height: 100vh;
        ...
        .hamburger-btn {
            ...
            padding: 5px 10px; display: none; cursor: pointer;
        }
