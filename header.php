...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Luxury login/register body styles */
        ...
        /* 🔥 Add login/register links in sidebar */
...
<div class="main-content">
    <?php if ($is_logged_in): ?>
    <!-- Top bar (user info) – keep as before -->
...
<!-- Sidebar toggle scripts (same as before) -->
<script>
